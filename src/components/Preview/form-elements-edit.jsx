...
import DynamicSelectList from './dynamic-select-list';
...
export default class FormElementsEdit extends React.Component {
  ...
  render() {
    ...
    const EnableLogicForm = this.props.element.hasOwnProperty('logicEnable') ? this.props.element.logicEnable : false;
    ...
    //const this_checked_logic_block = this.props.element.hasOwnProperty('logicBlock') ? this.props.element.logicBlock : false;
    const this_checked_alternate_form = this.props.element.hasOwnProperty('alternateForm') ? this.props.element.alternateForm : false;
    const {
      canHaveAlternateForm, canHaveDisplayHorizontal, canHaveOptionCorrect, canHaveOptionValue,
    } = this.props.element;
    console.log("canHaveAlternateForm", this_checked_alternate_form);
    ...
    return (
      <div>
        ...
        { this.props.element.hasOwnProperty('logicEnable') &&
          <div className="form-group">
          <label className="control-label"><IntlMessages id="text-style" /></label>
          <div className="custom-control custom-checkbox">
            <input id="do-bold" className="custom-control-input" type="checkbox" checked={EnableLogicForm} value={true} onChange={this.editElementProp.bind(this, 'enabled', 'checked')} />
          </div>
        </div>
        }
