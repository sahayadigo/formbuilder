      ...
      <div style={{ ...this.props.style }} className={baseClasses}>
        ...
        <div className="form-group">
          ...
          {this.props.read_only === true || !!sourceDataURL
            ? (<img src={sourceDataURL} alt="Data Url" />)
  ...
  render() {
    ...
    return (
      <div style={{ ...this.props.style, style }} className={baseClasses} >
        <ComponentHeader {...this.props} />
        { this.props.data.src &&
          <img src={this.props.data.src} width={this.props.data.width} height={this.props.data.height} alt="Data URL" />
        }
        { !this.props.data.src &&
...
FormElements.HyperLink_Success = HyperLink;
FormElements.HyperLink_Fail = HyperLink;
